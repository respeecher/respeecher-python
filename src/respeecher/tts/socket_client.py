...
from .types.cancellation_request import CancellationRequest
...
class AsyncTtsSocketClient(EventEmitterMixin):
    ...
    async def send_generate(self, message: ContextfulGenerationRequest) -> None:
        ...
        The message will be sent as a ContextfulGenerationRequest.
        """
        await self._send_model(message)

    async def send_cancel(self, message: CancellationRequest) -> None:
        """
        Send a message to the websocket connection.
        The message will be sent as a CancellationRequest.
        """
        await self._send_model(message)
...
class TtsSocketClient(EventEmitterMixin):
    ...
    def send_generate(self, message: ContextfulGenerationRequest) -> None:
        """
        Send a message to the websocket connection.
        The message will be sent as a ContextfulGenerationRequest.
        """
    ...
    def send_cancel(self, message: CancellationRequest) -> None:
        """
        Send a message to the websocket connection.
        The message will be sent as a CancellationRequest.
        """
